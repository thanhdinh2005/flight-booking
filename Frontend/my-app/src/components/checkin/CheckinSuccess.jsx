...
const css = `
  ...
  .as-root {
    ...
    --card: #fff;
    --terra: #c05c3a;
    --terra-dim: rgba(192,92,58,0.1);
    --terra-mid: rgba(192,92,58,0.25);
    --sage: #5c7a5e;
    --sage-dim: rgba(92,122,94,0.12);
    --ink: #1c1a18;
    --muted: #7a7068;
    --border: #e4ddd4;
    --gold: #d97706;
  ...
  .as-card:hover {
    ...
    box-shadow: 0 4px 18px rgba(192,92,58,0.1);
    transform: translateY(-2px);
  }
  .as-card.selected {
    border-color: var(--terra);
    background: #fffaf8;
    box-shadow: 0 4px 18px rgba(192,92,58,0.15);
  }
  ...
  .as-meal-card:hover {
    border-color: var(--terra-mid);
    transform: translateY(-2px);
    box-shadow: 0 4px 18px rgba(192,92,58,.1);
  }
  ...
  .as-meal-card.selected .as-meal-card__img { background: rgba(192,92,58,0.2); }
  ...
  .as-checkin-btn:hover { background: #a84830; }
